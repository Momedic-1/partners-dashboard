...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xl sm:text-2xl md:text-3xl font-semibold leading-none tracking-tight",
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-4 sm:p-6 md:p-8 pt-0", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex items-center justify-between p-4 sm:p-6 md:p-8 pt-0",
      className
    )}
    {...props}
  />
