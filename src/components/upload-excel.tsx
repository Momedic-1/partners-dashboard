    ...
    >
      <Card>
        ...
        <CardContent className="space-y-6">
          <div
            className={`flex flex-col items-center cursor-pointer justify-center border-2 border-dashed rounded-lg p-10 text-center transition-colors ${
              isDragging
          ...
          >
            ...
            <ul className="text-sm text-muted-foreground space-y-1 ml-5 list-disc">
              ...
              <li>
                Columns: <code>First Name</code>, <code>Last Name</code>,{" "}
                <code>Email Address(optional)</code>, <code>Phone Number</code>, 
                 <code>Password</code>, <code>Confirm Password</code>, <code>Gender</code>
              </li>
              <li>Max size: 5MB</li>
            ...
            <div className="mt-4 text-sm">
              ...
              <a href="/template.xlsx" className="text-primary hover:underline">
                Download template (firstName, lastName, emailAddress)
              </a>
            </div>
          </motion.div>
        </CardContent>
        ...
        <CardFooter>
          ...
          >
            {isUploading ? (
              ...
              <>
                <Upload className="mr-2 cursor-pointer h-4 w-4" />
                Upload and Process
              </>
            )}
          </Button>
